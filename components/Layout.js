          ...
          <div style={{display:'grid',gridTemplateColumns:'2fr 1fr 1fr 1fr',gap:44,paddingBottom:48,borderBottom:'1px solid rgba(255,255,255,.05)'}}>
            <div>
              ...
              <div style={{display:'flex',gap:9}}>
                <div style={{display:'flex',gap:9}}>
                <a href="https://www.facebook.com/csharptek/" target="_blank" rel="noopener noreferrer" style={{width:34,height:34,borderRadius:7,background:'rgba(255,255,255,.05)',border:'1px solid rgba(255,255,255,.07)',display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none'}} title="Facebook">
                ...
                <a href="https://in.linkedin.com/company/csharptek" target="_blank" rel="noopener noreferrer" style={{width:34,height:34,borderRadius:7,background:'rgba(255,255,255,.05)',border:'1px solid rgba(255,255,255,.07)',display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none'}} title="LinkedIn">
                ...
                <a href="https://twitter.com/csharptek1" target="_blank" rel="noopener noreferrer" style={{width:34,height:34,borderRadius:7,background:'rgba(255,255,255,.05)',border:'1px solid rgba(255,255,255,.07)',display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none'}} title="Twitter / X">
                ...
                <a href="https://instagram.com/csharptekofficial" target="_blank" rel="noopener noreferrer" style={{width:34,height:34,borderRadius:7,background:'rgba(255,255,255,.05)',border:'1px solid rgba(255,255,255,.07)',display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none'}} title="Instagram">
