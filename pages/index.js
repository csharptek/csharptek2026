...
const AutomationCard = dynamic(() => import('../components/industry-cards/AutomationCard'), { ssr: false })
const MarketplaceCard = dynamic(() => import('../components/industry-cards/MarketplaceCard'), { ssr: false })
const PetCareCard = dynamic(() => import('../components/industry-cards/PetCareCard'), { ssr: false })
const CRMCard = dynamic(() => import('../components/industry-cards/CRMCard'), { ssr: false })
const RealEstateCard = dynamic(() => import('../components/industry-cards/RealEstateCard'), { ssr: false })
...
const GLOBAL_STYLES = `
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .icard{border-radius:16px;overflow:hidden;cursor:pointer;aspect-ratio:3/4;position:relative;transition:transform .35s cubic-bezier(.22,1,.36,1),box-shadow .35s ease;}
  .icard:hover{transform:translateY(-8px) scale(1.02);box-shadow:0 32px 64px rgba(0,0,0,.5),0 0 28px rgba(46,158,214,.1);}
  .ibg{position:absolute;inset:0;transition:transform .45s cubic-bezier(.22,1,.36,1);background-size:cover;background-position:center;}
...
const INDUSTRIES = [
  {i:'🏥',n:'Healthcare',d:'HIPAA, EHR/FHIR, Epic, Medical Scribe',bg:'linear-gradient(135deg,#0D2B45,#1565A8)',Card:HealthcareCard},
  {i:'🌸',n:'Wellness & Fertility',d:"IVF, Fertility Clinics, Women's Wellness",bg:'linear-gradient(135deg,#0a2a1e,#0f6e56)',Card:WellnessCard},
  {i:'🎓',n:'Education & EdTech',d:'K-12, Internships, AI Evaluation',bg:'linear-gradient(135deg,#1a1a0a,#7a5a0a)',Card:EducationCard},
  {i:'🤖',n:'Marketing & Automation',d:'HubSpot, GoHighLevel, Apollo',bg:'linear-gradient(135deg,#1a0a1a,#6b2fa0)',Card:AutomationCard},
  {i:'🛒',n:'Service Marketplaces',d:'Multi-vendor, Bookings, Payments',bg:'linear-gradient(135deg,#0a1a1a,#0a5a5a)',Card:MarketplaceCard},
  {i:'🐾',n:'Pet Care & Wellness',d:'Vaccination Kiosk, RFID, Pet Tech',bg:'linear-gradient(135deg,#0a1a0a,#3a6a0a)',Card:PetCareCard},
  {i:'⚙️',n:'CRM & Productivity',d:'Custom CRMs, Internal Tools',bg:'linear-gradient(135deg,#1a0a0a,#8B2a2a)',Card:CRMCard},
  {i:'🏡',n:'Real Estate AI',d:'Property Listings, Lead Automation, CRM',bg:'linear-gradient(135deg,#0d1b2a,#1a5276)',Card:RealEstateCard},
]
const PROJECTS = [
