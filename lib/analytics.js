...
export const track = {
  ...
  // Blog
  blogView:           (slug, title)       => trackEvent('blog_view',              { blog_slug: slug, blog_title: title }),
  blogCardClick:      (slug, title)       => trackEvent('blog_card_click',        { blog_slug: slug, blog_title: title }),
  blogCommentSubmit:  (slug)              => trackEvent('blog_comment_submit',    { blog_slug: slug }),
  blogScrollDepth:    (depth, slug)       => trackEvent('blog_scroll_depth',      { depth_percent: depth, blog_slug: slug }),
  blogShare:          (platform, slug)    => trackEvent('blog_share',             { platform, blog_slug: slug }),
